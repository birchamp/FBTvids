...
// Full discussion content for web
...
• How did the Mai encourage the translation team? (possible answers: They told them about the hardships they were able to overcome, they explained how these hardships helped the church to strengthen its faith)
  - Discussion questions:
    • What hardships have you faced in your translation work?
    • How have these hardships helped to strengthen your faith or the faith of your community?`
  },
  {
    id: 4,
...
• What did the Tano learn about the importance of understanding the meaning before translating? (possible answer: They learned that they needed to understand the meaning first, then translate it into their own language forms)
  - Discussion question: How do you make sure you understand the meaning of a passage before you translate it?

• What process did the Mai teach the Tano for translating? (possible answers: They read the passage, discussed the meaning, then translated it into Tano forms)
  - Discussion question: What process do you use when translating?

• What did the Tano learn about checking their translation? (possible answer: They learned to check that nothing was added, nothing was missing, and nothing was changed)
  - Discussion question: How do you check your translations to make sure they are accurate?

• What did the Tano learn about the importance of natural language? (possible answer: They learned that the translation should sound natural in their language)
  - Discussion question: How do you make sure your translation sounds natural in your language?`
  },
  {
    id: 5,
...
• What did the Tano learn about the importance of testing their translation? (possible answer: They learned that they needed to test their translation with people who had not been involved in the translation process)
  - Discussion question: How do you test your translations with people who were not involved in the translation?

• What did the Tano learn about the importance of feedback? (possible answer: They learned that feedback from the community was important for improving the translation)
  - Discussion question: How do you gather feedback from your community about your translations?

• What did the Tano learn about the importance of revision? (possible answer: They learned that they needed to revise their translation based on the feedback they received)
  - Discussion question: How do you revise your translations based on feedback?

• What did the Tano learn about the importance of quality? (possible answer: They learned that quality was more important than speed)
  - Discussion question: How do you balance quality and speed in your translation work?`
  },
  {
    id: 6,
...
• What did the Tano learn about the importance of completion? (possible answer: They learned that completion was important for the community to use the translation)
  - Discussion question: How do you know when your translation is complete enough to use?

• What did the Tano learn about the importance of community ownership? (possible answer: They learned that the community needed to own the translation process)
  - Discussion question: How do you ensure that your community owns the translation process?

• What did the Tano learn about the importance of celebration? (possible answer: They learned that it was important to celebrate the completion of their translation)
  - Discussion question: How do you celebrate milestones in your translation work?

• What did the Tano learn about the importance of ongoing work? (possible answer: They learned that translation work is ongoing and never really finished)
  - Discussion question: How do you plan for ongoing revision and improvement of your translations?`
  },
  {
    id: 7,
...
• What did the Tano learn about the importance of sharing their translation? (possible answer: They learned that sharing their translation was important for the community to benefit from it)
  - Discussion question: How do you share your translations with your community?

• What did the Tano learn about the importance of training? (possible answer: They learned that training others to use the translation was important)
  - Discussion question: How do you train others to use your translations?

• What did the Tano learn about the importance of distribution? (possible answer: They learned that they needed to think about how to distribute their translation)
  - Discussion question: How do you distribute your translations to your community?

• What did the Tano learn about the importance of impact? (possible answer: They learned that they wanted their translation to have a positive impact on their community)
  - Discussion question: How do you measure the impact of your translations on your community?`
  }
];

// Thumbnails use .webp on web (only)
...
// Do NOT require mp4 on web. Return null so UI shows fallback.
